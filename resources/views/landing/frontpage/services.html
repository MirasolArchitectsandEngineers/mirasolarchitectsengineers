...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-nav-target" data-offset="20">
    ...
    <div class="unslate_co--site-wrap">
      ...
      <div class="cover-v1 jarallax" style="background-image: url('images/appointment-benner.jpg');" id="home-section">
        <div class="container">
          ...
          <div class="row mt-5 justify-content-between">
            <div class="col-lg-6 mb-5 mb-lg-10">
              <figure class="dotted-bg gsap-reveal-img ">
                <img src="images/architecture-building.png" alt="Image" class="img-fluid">
              </figure>
            </div>
