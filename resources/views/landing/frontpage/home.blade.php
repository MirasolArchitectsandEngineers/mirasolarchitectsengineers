...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-nav-target" data-offset="20">
    ...
    <div class="unslate_co--site-wrap">
      ...
      <div class="cover-v1 jarallax" style="background-image: url('images/297881865_172689311929390_1950189024350130841_n.jpg');" id="home-section">
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-md-7 mx-auto text-center">
              ...
              <h1 class="heading gsap-reveal-hero"><img src="images/Untitled-2.png" class="lazyload  img-fluid" alt="Images" /></h1>
      ...
      <div class="unslate_co--section" id="this-section">
        <div class="col-12">
          ...
          <div class="item web packaging col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
                ...
                <a href="images/311735634_186902230508098_8401930685156898117_n.jpg" class="this-item isotope-item gsap-reveal-img" data-fancybox="gallery" data-caption="Watch">
                    <div class="overlay">
                    ...
                    <img src="images/311735634_186902230508098_8401930685156898117_n.jpg" class="lazyload  img-fluid" alt="Images" />
                  </a>

              </div>
                 <div class="item branding packaging col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
                <a href="images/313020122_188432873688367_8565865133771706285_n.jpg" class="this-item item-portrait isotope-item gsap-reveal-img " data-fancybox="gallery" data-caption="Modern Building">
                    <div class="overlay">
                      <span class="wrap-icon icon-photo2"></span>
                      <div class="this-item-content">
                        <h3>Corporate</h3>
                    ...
                    <img src="images/313020122_188432873688367_8565865133771706285_n.jpg" class="lazyload  img-fluid" alt="Images" />
                  </a>
              </div>
          <div class="item web packaging col-sm-6 col-md-6 col-lg-4 isotope-mb-2">

                <a href="images/382230286_331340362730950_4183704594503918235_n.jpg" class="this-item isotope-item gsap-reveal-img" data-fancybox="gallery" data-caption="Watch">
                    <div class="overlay">
                      <span class="wrap-icon icon-photo2"></span>
                      <div class="this-item-content">
                    ...
                    <img src="images/382230286_331340362730950_4183704594503918235_n.jpg" class="lazyload  img-fluid" alt="Images" />
                  </a>

              </div>
         <div class="item branding packaging col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
                <a href="images/363359676_301862389012081_1941683697978561029_n.jpg" class="this-item item-portrait isotope-item gsap-reveal-img " data-fancybox="gallery" data-caption="Modern Building">
                    <div class="overlay">
                      <span class="wrap-icon icon-photo2"></span>
                      <div class="this-item-content">
                    ...
                    <img src="images/363359676_301862389012081_1941683697978561029_n.jpg" class="lazyload  img-fluid" alt="Images" />
                  </a>
              </div>
          <div class="item web packaging col-sm-6 col-md-6 col-lg-4 isotope-mb-2">

                <a href="images/312912065_188432883688366_8688871015789825250_n.jpg" class="this-item isotope-item gsap-reveal-img" data-fancybox="gallery" data-caption="Watch">
                    <div class="overlay">
                      <span class="wrap-icon icon-photo2"></span>
                      <div class="this-item-content">
                    ...
                    <img src="images/312912065_188432883688366_8688871015789825250_n.jpg" class="lazyload  img-fluid" alt="Images" />
                  </a>

              </div>

       <div class="item branding packaging col-sm-6 col-md-6 col-lg-4 isotope-mb-2">
                <a href="images/310432111_186902260508095_4822510034040461973_n.jpg" class="this-item item-portrait isotope-item gsap-reveal-img " data-fancybox="gallery" data-caption="Modern Building">
                    <div class="overlay">
                      <span class="wrap-icon icon-photo2"></span>
                      <div class="this-item-content">
                        <h3>Fabrication</h3>
                    ...
                    <img src="images/310432111_186902260508095_4822510034040461973_n.jpg" class="lazyload  img-fluid" alt="Images" />
                  </a>
              </div>
        ...
        <div style="color:white;" class="owl-carousel testimonial-slider" data-aos="fade-up">
          <div>
            <div class="testimonial-v1">
              ...
              <div class="testimonial-author-info">
                <img style="filter: blur(4px)" src="images/person_man_1.jpg" alt="Image">
                <h3>Eric Ingram</h3>
          ...
          <div>
            <div class="testimonial-v1">
              ...
              <div class="testimonial-author-info">
                <img style="filter: blur(4px)" src="images/person_man_2.jpg" alt="Image">
                <h3>Ryan Mullins</h3>
          ...
          <div>
            <div class="testimonial-v1">
              ...
              <div class="testimonial-author-info">
                <img style="filter: blur(4px)" src="images/person_woman_1.jpg" alt="Image">
                <h3>Erica Miller</h3>
