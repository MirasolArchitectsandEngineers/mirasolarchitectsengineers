...
<html lang="en">
  ...
  <body data-spy="scroll" data-target=".site-nav-target" data-offset="20">
    ...
    <div class="unslate_co--site-wrap">
      ...
      <div class="cover-v1 jarallax" style="background-image: url('images/habitation-bg.jpg');" id="home-section">
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-md-7 mx-auto text-center">
             ...
             <h1 class="heading gsap-reveal-hero">TESTIMONIALS</h1>
              <h2 style="font-size: 18px;" class="subheading gsap-reveal-hero">HOME-TESTIMONIALS</h2>
            </div>
